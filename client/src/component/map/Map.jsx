  ...
  return (
    <LoadScript googleMapsApiKey={process.env.REACT_APP_GOOGLE_MAPS_KEY}>
      <GoogleMap center={{ lat, lng, }}
        mapContainerStyle={{ width: '100%', height: '300px', marginBottom: '10px', }}
        zoom={zoom}
      >
        {
          hasTwoAddresses && (
            <DirectionsService options={{ origin: pickUpAddress, destination: dropOffAddress, travelMode: 'DRIVING'}}
